...
@RestController
public class CreditCancelMobileResource {

    private final static Logger logger = LoggerFactory.getLogger(CreditCancelMobileResource.class);
    ...
    //app-撤销确认页
    @PostMapping("/authed/app/credit/creditCancel/confirm")
    ...
    //app-yjt撤销确认页
    @PostMapping("/authed/app/yjt/creditCancel/confirm")
    ...
    //app-债权实际调用接口
    @AutoLogger
    @PostMapping("/authed/app/credit/creditCancel/finish")
