 ...
 * @author ke 2017/4/25
 */
public class RequestAsyncTransaction extends BaseRequest {

    private String batchNo;//批次号
    private List<BizDetail> bizDetails;//交易明细
    ...
    public static class BizDetail {
        ...
        private List<Detail> details;//业务明细
    ...
    public void setBizDetails(List<BizDetail> bizDetails) {
