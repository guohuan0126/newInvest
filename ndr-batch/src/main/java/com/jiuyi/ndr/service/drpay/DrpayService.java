...
public class DrpayService {
    ...
    public static final String AUTO_WITHDRAW = "/payment/autoWithdraw.do";
    ...
    public static String send(String serviceUrl, Map<String, Object> obj) {
        ...
        try {
            ...
            result = DRHTTPClient.sendHTTPRequestPostToString(DRHTTPClient.createSSLClientDefault(), drpayUrl + serviceUrl, new Header[0], params);
